...
dados::pixar_avalicao_publico %>%
  ...
  ggplot2::geom_col(fill = "#FFEF03", color = "#FD0B0A") +
  ggplot2::facet_wrap(critica ~ .) +
  ggplot2::theme_light() +
  ggplot2::theme(
    panel.background = ggplot2::element_rect(fill = "black"),
    panel.grid = ggplot2::element_blank(),
    axis.text.y = ggplot2::element_text(color = "#FD0B0A"),
    axis.text.x = ggplot2::element_text(color = "#203DBD"),
    strip.background = ggplot2::element_rect(fill = "white"),
    strip.text = ggplot2::element_text(color = "#203DBD"),
...
pixar_completo %>%
  ...
  dplyr::rename(`bilheteria mundial` = bilheteria_mundial) %>%
  ...
  ggplot2::geom_col(color = "#203DBD") +
  ggplot2::scale_fill_manual(values = c("#FFEF03", "#FD0B0A")) +
...
pixar_completo %>%
  ...
  ggplot2::geom_col(color = "#EA623B") +
  ggplot2::scale_fill_manual(values = c("#628528", "#FD0B0A", "#203DBD", "#FDA40C", "#FFEF03")) +
  ggplot2::theme_light() +
  ggplot2::theme(
    panel.background = ggplot2::element_rect(fill = "black"),
    panel.grid = ggplot2::element_blank(),
